...
// user-SignUp 
  ...
  export const verifyEmail = async (email: string): Promise<any> => {
    try {
      const response = await API.post(
        authentictaionRoutes.verifyEmail_user,
        {
          email,
        }
      ); 
 ...
 // after verified email send otp and check verifyResetOtp ,  forgotResendOtp
 ...
 export const verifyResetOtp = async (
  ...
  try {
    const response = await API.post(
      authentictaionRoutes.verifyResetOtp_user,
      {
        email,
        otp,
      },
...
export const forgotResendOtp = async (email: string): Promise<any> => {
  try {
    const response = await API.post(
      authentictaionRoutes.forgotResendOtp_user,
      {
        email,
      }
    );
...
export const resetPassword = async (password: string): Promise<any> => {
  try {
    const response = await API.post(
      authentictaionRoutes.resetPassword_user,
      {
        password,
      },
      {
